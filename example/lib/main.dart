...
class _MyAppState extends State<MyApp> {
  ...
  // Inner Test AppKey
  static const appKey = '45c6af3c98409b18a84451215d0bdd6e';
  static const chatroomId = '3001';

  // Inner Test Configuration 1
  static const account = '260974291521792';
  static const token = '5b8b5bca-c4b4-4d60-884f-42adc6425fa2';
  static const friendAccount = '263248940175616';
  ...
  void _testTeam() async {
    ...
    final ret102 = await NimCore.instance.teamService
        .muteTeamMember(teamId, 'jinjie00', true);
    print('_testTeam muteTeamMember ${ret102.code}');
    final ret103 = await NimCore.instance.teamService
        .muteTeamMember(teamId, 'jinjie00', false);
