...
enum SessionType: String {
    ...
    static let allValues = [SessionCreate,SessionRecentList,SessionCustomRecentList,SessionspecifySession,SessionUpdate,UpdateSessionWithMessage,SessionUnreadCount,SessionMarkRead,SessionSyncUnreadCount,SessionDeleteRecent,SetChattingAccount,ClearAllSessionUnreadCount]
}
...
//    }
    ...
    func onMethodCalled(_ method: String, _ arguments: [String : Any], _ resultCallback: ResultCallback) {
        ...
        case SessionType.ClearAllSessionUnreadCount.rawValue: clearAllSessionUnreadCount(arguments, resultCallback)
        default:
            break
        }
    }
                ...
                if let ns_error = error as NSError? {
                    ...
                    let ret = retSessions?.map({ session in
                        [
                            ...
                            "sessionType":FLT_NIMSessionType.convertFLTSessionType(session.sessionType)?.rawValue
                        ]
                    })
    ...
    private func clearAllSessionUnreadCount(_ argument:[String : Any],  _ resultCallback: ResultCallback) {
